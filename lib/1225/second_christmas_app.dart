                              ...
                              return Container(
                                ...
                                child: Row(
                                    children: <Widget>[
                                      // check icon
                                      Icon(
                                        family[index].isChecked? Icons.check_circle_outline : Icons.remove_circle_outline,
                                        size: 16.0,
                                        color: family[index].isChecked? Colors.green : _bottomColor,
                                      ),

                                      SizedBox(width: 8.0),

                                      // text: Mom
                                      Text(family[index].text,
                                        style: TextStyle(
                                          fontSize: 16.0,
                                          color: Colors.black,
